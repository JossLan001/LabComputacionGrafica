...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_F)
	{
		if (theWindow->pataizqdel > 45.0)
		{

		}
		else
		{
			theWindow->pataizqdel += 10.0;
		}
	}
	...
	if (key == GLFW_KEY_H)
	{
		if (theWindow->pataderdel > 45.0)
		{

		}
		else
		{
			theWindow->pataderdel += 10.0;
		}
	}
	...
	if (key == GLFW_KEY_K)
	{
		if (theWindow->pataizqtras > 45.0)
		{

		}
		else
		{
			theWindow->pataizqtras += 10.0;
		}
	}
	...
	if (key == GLFW_KEY_M)
	{
		if (theWindow->patadertras > 45.0)
		{

		}
		else
		{
			theWindow->patadertras += 10.0;
		}
	}
